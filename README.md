# package.json/watch & Standard's Style Guide for task automation with minimal configuration
...
```
cd
git clone https://github.com/user/cacheprovider style-config
```
...
```
~/style-config/cacheprovider-config.sh
```
